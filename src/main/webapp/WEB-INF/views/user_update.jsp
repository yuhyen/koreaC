        ...
        <div class="max-w-2xl mx-auto bg-white p-6 rounded-md shadow-md">
            ...
            <form>
                ...
                <div class="flex justify-end space-x-4">
                	...
                	<input type="button" value="수정하기"  class="py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" onclick="u_update(this.form)">
